...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner pais;
    ImageView imageView;
    Button btnGuardar,btnGuardados,btnfoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardados = (Button) findViewById(R.id.btnsalvados);
        btnfoto = (Button) findViewById(R.id.btnfoto);
        imageView = (ImageView) findViewById(R.id.imageView);

        String[] paises = {"Honduras(+504)", "Guatemala(+502)", "Costa Rica(+506)","Belize(+501)","Nicaragua(+505)","Panamá(+507)","El Salvador(+503)","Mexico(+52)",
        "EEUU(+1)","Haiti(+509)","Cuba(+53)","Peru(+51)","Argentina(+54)","Brasil(+55)","Chile(+56)","Colombia(+57)","Venezuela(+58)","Bolivia(+591)","Guyana(+592)",
        "Ecuador(+593)","Paraguay(+595)","Uruguay(+598)","Gresia(+30)","Paise Bajos(+31)","Belgica(+32)","Francia(+33)","España(+34)","Rusia(+7)","Portugal(+351)"};
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (intent.hasExtra("id")) {
                    updatePerson();
                    Intent intent = new Intent(MainActivity.this, ActivityGuardados.class);
    ...
    private void AddPerson() {
        ...
        if (nombre.isEmpty()) {
            ...
            Long resultado = db.insert(Transaciones.Tablapersonas, Transaciones.id, valores);
    ...
    private void updatePerson() {
        ...
        int filasAfectadas = db.update(Transaciones.Tablapersonas, valores, Transaciones.id + "=?", new String[]{idPersona});
        db.close();
