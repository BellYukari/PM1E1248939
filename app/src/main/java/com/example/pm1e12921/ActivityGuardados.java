...
public class ActivityGuardados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listpersonas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ActivityGuardados.this);
        ...
        btneliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (posicionSeleccionada != -1) {
                    ...
                    adapter = new ArrayAdapter<>(ActivityGuardados.this, android.R.layout.simple_list_item_1, Arreglo);
        ...
        btnactualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (posicionSeleccionada != -1) {
                    ...
                    Intent intent = new Intent(ActivityGuardados.this, MainActivity.class);
        ...
        btnverimagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (posicionSeleccionada != -1) {
                    ...
                    Intent intent = new Intent(ActivityGuardados.this, ActivityMostrarImagen.class);
    ...
    private void makePhoneCall() {
        ...
        builder.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(ActivityGuardados.this, ActivityLlamada.class);
    ...
    private void eliminarPersona(int posicion) {
        ...
        db.delete(Transaciones.Tablapersonas, Transaciones.id + "=?", new String[]{String.valueOf(personaSeleccionada.getId())});
        db.close();
    }
